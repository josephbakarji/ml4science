...
- name: Introduction to Linear Regression
  type: video
  label: recommended
  url: https://www.youtube.com/watch?v=3zHWnd-7FkA
material:
- name: From Empirical Laws to Linear Regression (PDF)
  type: slides
  url: /static_files/lectures/02/from_empirical_laws_to_linreg.pdf
...
references:
- name: A Brief History of Empirical Modeling (interactive slides)
  type: slides
  url: https://learn.sematlas.com/slides/01_brief_history
- name: A Brief Introduction to Machine Learning (From Physics)
  type: video
  label: recommended
