...
preparation:
- name: 'Review: Derivatives and Partial Derivatives'
  type: video
  label: recommended
...
- name: Scientific Modeling Principles
  type: slides
  url: https://learnslides.onrender.com/slides/04_scientific_modeling
- name: 'Lecture Notes: Scientific Modeling Principles'
  type: notes
  label: required
  url: /static_files/lectures/04/notes_scientific_modeling_principles
- name: 'Reference: Introduction to PDEs'
  type: notes
  label: optional
  url: /static_files/lectures/04/intro_to_pdes
