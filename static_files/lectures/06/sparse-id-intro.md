...
## 3. Constructing the Feature Library and Design Matrix

### 3.1 Feature Library

A **feature library** $$\Phi$$ is a set of candidate functions:
$$
\Phi(x) \;=\;
\begin{bmatrix}
\phi_1(x)\\
...
We arrange our time-derivative approximations $$\xhat{}^{(i)}$$ into a vector
$$
\hat{\mathbf{\dot{x}}}
\;=\;
\begin{bmatrix}
...
### 7.3 Building the PDE Library and Regression
