...
(f) How does [SVM](\href{https://scikit-learn.org/stable/modules/svm.html) compare to Logistic Regression on this data-set? Briefly describe what loss function SVM is minimizing.
