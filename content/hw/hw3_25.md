---
layout: page
title: "Problem Set #3 - Differential Equations And Probabilistic Models"
permalink: /content/hw/hw3_25/
---

If you use notebooks, provide a brief explanation for each question using the markdown functionality. I encourage you to discuss the problems, but when you write down the solution please do it on your own. You can raise and answer each other's questions on Slack; but please don't provide exact solutions. Submit Jupyter notebooks (or scripts) for all problems.
