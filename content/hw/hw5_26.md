...
**Data:** Download the spring oscillation video here: [spring-osc-trim.mov](/static_files/data/spring-osc-trim.mov). Starter code for reading the video with OpenCV is available in this [Colab notebook](https://colab.research.google.com/drive/126iJ0Zq4OOoRkSLN7mQwTmMk66PwoU-h?usp=sharing).
